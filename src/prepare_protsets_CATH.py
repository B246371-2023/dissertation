...
domain_df = pd.read_csv('../../CATH_data_old/cath-domain-list.txt' , comment='#' , header = None , delim_whitespace=True)
...
siftsdf = pd.read_csv('../../CATH_data_old/pdb_chain_cath_uniprot_copy.csv', header=1 )
